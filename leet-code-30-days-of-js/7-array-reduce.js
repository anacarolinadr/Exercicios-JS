...
// and an initial value init, return the final result obtained by executing 
// the fn function on each element of the array, sequentially, passing in 
...
/* Tests
console.log(reduce([1,2,3,4], function sum(accum, curr) { return accum + curr * curr; }, init = 100))
*/